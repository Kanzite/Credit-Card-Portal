		...
		return(
			<div className="formcard" ref={this.formref}>
				<form onSubmit={this.props.handleSubmit}>
					...
					<input type="text" className="textinp" name="name" placeholder="Full Name" pattern="[a-zA-Z ]+" value={this.props.state.name} onChange={this.props.handleInputChange} onKeyUp={this.props.handleKeyUp} required/>
